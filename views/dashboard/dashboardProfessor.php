...
$datos->getCoursestoProfessors();
$courses = $datos->rows;
?>

<?php include("includes/navbar.php") ?>
<div class="topnav">
<a href="#news">HOLA PROFESOR BIENVENIDO A ITECBO</a>
  <a href="#news"><?php echo $user?></a>
  <label id="switch">
            <input type="checkbox" onclick="resetStyle('Idhtml', 'img', 'video', 'iframe');";>
            <span class="slider round"></span>
          </label>
  <a href="courses/createCourse/createCourseView.php">Crear curso</a>
